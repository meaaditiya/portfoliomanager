const getApplicationConfirmationTemplate = (applicantName, roleTitle, companyName, applicationId) => {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Your application has been received successfully</title>
  <style>
    body {
...
<body>
  <div class="email-container">
    ...
    <div class="email-content">
      ...
      <p>Thank you for applying for <strong>${roleTitle}</strong> at <strong>${companyName}</strong>.</p>
      <p>Your application has been received and is now under review.</p>
      <p><strong>Your application ID:</strong> ${applicationId}</p>
      <p>You can use this application ID to check your application status anytime on the site.</p>
      <p>We will keep you updated as your application progresses.</p>
...
module.exports = getApplicationConfirmationTemplate;