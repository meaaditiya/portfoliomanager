const getAdminApplicationNotificationTemplate = (applicantName, applicantEmail, roleTitle, companyName, applicationId, applicationType) => {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="email-container">
    <div class="email-header">
      ...
      <div class="subject-section">
        <h1>New ${applicationType === 'referral' ? 'referral' : 'job'} application</h1>
      </div>
    </div>

    <div class="email-content">
      <h2>Dear Admin,</h2>
      <p>A new application has been submitted for <strong>${roleTitle}</strong> at <strong>${companyName}</strong>.</p>
      <p><strong>Applicant name:</strong> ${applicantName}</p>
      <p><strong>Applicant email:</strong> ${applicantEmail}</p>
      <p><strong>Application ID:</strong> ${applicationId}</p>
      <p>Log in to the admin panel to review the full application and update its status.</p>
...
module.exports = getAdminApplicationNotificationTemplate;