const getApplicationStatusUpdateTemplate = (applicantName, roleTitle, companyName, applicationId, statusLabel, statusNote) => {
...
<body>
  <div class="email-container">
    ...
    <div class="email-content">
      ...
      <p>There has been an update on your application for <strong>${roleTitle}</strong> at <strong>${companyName}</strong>.</p>
      <p><strong>Application ID:</strong> ${applicationId}</p>
      <p><strong>New status:</strong> ${statusLabel}</p>
      ${noteBlock}
      <p>You can check your application status anytime on the site using your application ID.</p>
...
module.exports = getApplicationStatusUpdateTemplate;