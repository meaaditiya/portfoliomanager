...
const Login = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://connectwithaaditiyamg2.onrender.com/api/admin/login', {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await axios.post('https://connectwithaaditiyamg2.onrender.com/api/admin/forgot-password', { 
        email: forgotEmail
      });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await axios.post('https://connectwithaaditiyamg2.onrender.com/api/admin/reset-password', {
